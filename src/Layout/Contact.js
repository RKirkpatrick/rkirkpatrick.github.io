			...
			<article id="contact" className="boxshadow">
				<form id="contact" action="index.php" method="post">
					...
					<fieldset class="alignleft fifty boxshadow contactform">
						...
						<input name="firstlastname" id="firstlastname" type="text" required placeholder="John Smith"  maxlength="32" />
						<label for="emailaddress">Email</label>
						<input name="emailaddress" id="emailaddress" required type="email" placeholder="JohnSmith@example.com"  maxlength="32" />
						<label for="phone">Phone</label>
						<input name="phone" id="phone" type="tel" required placeholder="503-555-5555"  maxlength="12" />
						<label for="web">Website</label>
						<input name="web" id="web" type="url" required placeholder="www.JohnSmith.com"  maxlength="40" />
					</fieldset>
